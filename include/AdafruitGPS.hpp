#ifndef ADAFRUITGPS_HPP
#define ADAFRUITGPS_HPP
...
#define NMEA_MAX_SENTENCE_ID 120
...
class AdafruitGPS {
public: 
    bool begin(uart_inst_t* uart_chn, uint32_t baudrate, uint32_t tx_pin, uint32_t rx_pin);
