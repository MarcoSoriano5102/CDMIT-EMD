...
*/
/**************************************************************************/
bool AdafruitGPS::parse(char *nmea) {
  if (!check(nmea))
    return false;
...
*/
/**************************************************************************/
bool AdafruitGPS::check(char *nmea) {
...
*/
/**************************************************************************/
const char *AdafruitGPS::tokenOnList(char *token, const char **list) {
...
*/
/**************************************************************************/
bool AdafruitGPS::onList(char *nmea, const char **list) {
...
*/
/**************************************************************************/
bool AdafruitGPS::parseCoord(char *pStart, nmea_float_t *angleDegrees,
...
*/
/**************************************************************************/
char *AdafruitGPS::parseStr(char *buff, char *p, int n) {
  char *e = strchr(p, ',');
  int len = 0;
  if (e) {
...
*/
/**************************************************************************/
bool AdafruitGPS::parseTime(char *p) {
...
*/
/**************************************************************************/
bool AdafruitGPS::parseFix(char *p) {
  if (!isEmpty(p)) {
    if (p[0] == 'A') {
      fix = true;
      lastFix = sentTime;
...
*/
/**************************************************************************/
bool AdafruitGPS::parseAntenna(char *p) {
  if (!isEmpty(p)) {
    if (p[0] == '3') {
      antenna = 3;
    } else if (p[0] == '2') {
...
*/
/**************************************************************************/
bool AdafruitGPS::isEmpty(char *pStart) {
