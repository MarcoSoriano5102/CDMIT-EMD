...
*/
/**************************************************************************/
void AdafruitGPS::newDataValue(nmea_index_t idx, nmea_float_t v) {
...
*/
/**************************************************************************/
nmea_float_t AdafruitGPS::get(nmea_index_t idx) {
...
*/
/**************************************************************************/
nmea_float_t AdafruitGPS::getSmoothed(nmea_index_t idx) {
  if (idx >= NMEA_MAX_INDEX || idx < NMEA_HDOP)
    return 0.0;
...
*/
/**************************************************************************/
void AdafruitGPS::initDataValue(nmea_index_t idx, char *label, char *fmt,
...
*/
/**************************************************************************/
nmea_history_t *AdafruitGPS::initHistory(nmea_index_t idx, nmea_float_t scale,
                                          nmea_float_t offset,
...
*/
/**************************************************************************/
void AdafruitGPS::removeHistory(nmea_index_t idx) {
  if (idx < NMEA_MAX_INDEX) {
    if (val[idx].hist == NULL)
      return;
...
*/
/**************************************************************************/
// void AdafruitGPS::showDataValue(nmea_index_t idx, int n) {
//   Serial.print("idx: ");
//   if (idx < 10)
//     Serial.print(" ");
//   Serial.print(idx);
...
*/
/**************************************************************************/
bool AdafruitGPS::isCompoundAngle(nmea_index_t idx) {
...
*/
/**************************************************************************/
nmea_float_t AdafruitGPS::boatAngle(nmea_float_t s, nmea_float_t c) {
...
*/
/**************************************************************************/
nmea_float_t AdafruitGPS::compassAngle(nmea_float_t s, nmea_float_t c) {
